...
class scDEF(object):
    ...
    def _resolve_init_gene_scale_array(
        ...
        from scdef.models.extend import _resolve_init_gene_scale_array

        return _resolve_init_gene_scale_array(
            reference_model, init_gene_scale, n_batches, n_genes
        )
    ...
    def from_reference(cls, reference_model, adata, **kwargs):
        ...
        return from_reference(reference_model, adata, **kwargs)
    ...
    def add_batch_correction(cls, reference_model, batch_key, **kwargs):
        ...
        return add_batch_correction(reference_model, batch_key, **kwargs)
    ...
    def decompose_batch_effects(cls, reference_model, **kwargs):
        ...
        return decompose_batch_effects(reference_model, **kwargs)
    ...
    def from_hierarchy(cls, adata, hierarchy, **kwargs):
        ...
        return from_hierarchy(adata, hierarchy, **kwargs)

    @staticmethod
    def _reference_model_kwargs(reference_model, layer_sizes):
        from scdef.models.extend import _reference_model_kwargs

        return _reference_model_kwargs(reference_model, layer_sizes)
