"""
Run hierarchical clustering on 1-layer scDEF, and on Leiden at a high resolution. 
Compare both the cell type ARI and the hierarchy accuracy to their other versions. 
"""
